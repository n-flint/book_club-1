...
RSpec.describe 'in user index', type: :feature do
  ...
  it 'can click Most Pages link to sort by descending page length' do
    ...
    within '#book-list' do
      ...
      RSpec::Matchers.define :appear_before do |book_1|
        match do |book_2|
          page.body.index(book_2) < page.body.index(book_1)
        end
      end
    end
  end
  ...
  it 'can click Least Pages link to sort by ascending page length' do
    ...
    within '#book-list' do
      ...
      RSpec::Matchers.define :appear_before do |book_2|
        match do |book_1|
          page.body.index(book_1) < page.body.index(book_2)
        end
      end
    end
  end
  ...
  before :each do
    ...
    @author_1 = @book_1.authors.create(name: "Noah")
  ...
  it 'author name is link to show page' do
    visit books_path
